  ...
  <div class="head-top-inner">
  		<div class="top-left">
        	<?php if(get_theme_mod('email') != '') { ?>
        		<div class="mail">
                	<i class="fa fa-envelope" aria-hidden="true"></i> <a href="<?php echo esc_url('mailto:'.get_theme_mod('email')); ?>"><?php echo esc_attr(get_theme_mod('email')); ?></a>
                </div><!-- mail -->
           <?php } ?>
